...
namespace Nemo.Fn
{
    ...
    public static class StreamExtensions
    {
        ...
        {
            return st1 == null || st1.IsEmpty() ? init : folder(st1.Head, st1.Tail == null ? init : st1.Tail.FoldRight(folder, init));
        }

        public static T FoldLeft<U, T>(this Stream<U> st1, Func<T, U, T> folder, T init)
        {
            return st1 == null || st1.IsEmpty() ? init : st1.Tail.FoldLeft(folder, folder(init, st1.Head));
        }
