...
namespace NemoTest
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var retrieve_customer_orders_ids_sql = ObjectFactory.Retrieve<long>(sql: "select OrderID from Orders where CustomerID = @CustomerID", parameters: new ParamList { CustomerID => "ALFKI" });
