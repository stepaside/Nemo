...
namespace Nemo.Fn.Utilities
{
    ...
    public class Tuple<T1> : ITuple
    {
        ...
        {
            return string.Format("{0}", Item1.ToString());
        }

        public virtual bool Contains<T>(T value)
        {
            return typeof(T) == typeof(T1) && object.Equals(Item1, value);
        }
    ...
    public class Tuple<T1, T2> : Tuple<T1>, ITuple
    {
        ...
        {
            return base.Contains(value) || (typeof(T) == typeof(T2) && object.Equals(Item2, value));
        }
    ...
    public class Tuple<T1, T2, T3> : Tuple<T1, T2>, ITuple
    {
        ...
        public override bool Contains<T>(T value)
        {
            return base.Contains(value) || (typeof(T) == typeof(T3) && object.Equals(Item3, value));
        }
    ...
    public class Tuple<T1, T2, T3, T4> : Tuple<T1, T2, T3>, ITuple
    {
        ...
        public override bool Contains<T>(T value)
        {
            return base.Contains(value) || (typeof(T) == typeof(T4) && object.Equals(Item4, value));
        }
    ...
    public class Tuple<T1, T2, T3, T4, T5> : Tuple<T1, T2, T3, T4>, ITuple
    {
        ...
        string ITuple.GetString()
        {
            return string.Format("{0},{1},{2},{3},{4}", Item1.ToString(), Item2.ToString(), Item3.ToString(), Item4.ToString(), Item5.ToString());
        }

        public override bool Contains<T>(T value)
        {
            return base.Contains(value) || (typeof(T) == typeof(T5) && object.Equals(Item5, value));
        }
    ...
    public class Tuple<T1, T2, T3, T4, T5, T6> : Tuple<T1, T2, T3, T4, T5>, ITuple
    {
        ...
        string ITuple.GetString()
        {
            return string.Format("{0},{1},{2},{3},{4},{5}", Item1.ToString(), Item2.ToString(), Item3.ToString(), Item4.ToString(), Item5.ToString(), Item6.ToString());
        }

        public override bool Contains<T>(T value)
        {
            return base.Contains(value) || (typeof(T) == typeof(T6) && object.Equals(Item6, value));
        }
    ...
    public class Tuple<T1, T2, T3, T4, T5, T6, T7> : Tuple<T1, T2, T3, T4, T5, T6>, ITuple
    {
        ...
        string ITuple.GetString()
        {
            return string.Format("{0},{1},{2},{3},{4},{5},{6}", Item1.ToString(), Item2.ToString(), Item3.ToString()
                , Item4.ToString(), Item5.ToString(), Item6.ToString(), Item7.ToString());
        }

        public override bool Contains<T>(T value)
        {
            return base.Contains(value) || (typeof(T) == typeof(T7) && object.Equals(Item7, value));
        }
        ...
        where TRest : ITuple
    {
        ...
        string ITuple.GetString()
        {
            return string.Format("{0},{1},{2},{3},{4},{5},{6},{7}", Item1.ToString(), Item2.ToString(), Item3.ToString()
                , Item4.ToString(), Item5.ToString(), Item6.ToString(), Item7.ToString(), Rest.GetString());
        }
